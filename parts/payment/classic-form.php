<div class="to_fade_in" style="display: none;">
	<form action="https://checkout.globalgatewaye4.firstdata.com/pay" id="pay_now_form_9887b9a25c" method="post" style="margin-bottom: 0px;" id="payment_form">
		<br>
		<input type="number" class="text-field w-input" maxlength="30" name="x_reference_3" placeholder="Discord ID (Ex: 239132435706761325)" id="discord_id" required style="margin-bottom: 0.5em; -webkit-appearance: none;">
		...
		<input type="hidden" name="x_invoice_num" value="<?php echo uniqid('', TRUE); ?>">
		<input type="hidden" name="x_po_num" value="USD">
		...
		<input type="hidden" name="x_line_item" value="<|><|><?php if(discounted()) echo 'Discounted '; ?>Classic Subscription (1 Month)<|>1<|><?php if(discounted()) echo '15.00'; else echo '20.00'; ?><|><|><?php if(discounted()) echo '099101'; else echo '099102';?><|>91582<|>Each<|><|><|>0.00<|><|><?php if(discounted()) echo '0.00<|>15.00'; else echo '0.00<|>20.00'; ?>">
